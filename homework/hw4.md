...
*   You may find the following links helpful when implementing the functions for your scheduling class. [Sched class methods](https://mgouzenko.github.io/jekyll/update/2016/11/24/understanding-sched-class.html), [Medium Article](https://deepdives.medium.com/digging-into-linux-scheduler-47a32ad5a0a8), [Scheduler deep dive](https://helix979.github.io/jkoo/post/os-scheduler/). Please note that some of the information in the links may be outdated (e.g. the second source claims the scheduling classes have ".next" pointers to the scheduling class of next highest precedence, which is no longer accurate), so while they are helpful as a reference, your best "source of truth" is still the 6.8 kernel.
